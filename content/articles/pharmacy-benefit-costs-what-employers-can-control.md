---
title: "Pharmacy Benefit Costs: What Employers Can Actually Control"
slug: "pharmacy-benefit-costs-what-employers-can-control"
date: "2026-04-02"
author: "Benefits Collective"
category: "Pharmacy Strategy"
tags: ["pharmacy", "cost reduction", "PBM", "specialty drugs"]
excerpt: "Pharmacy is the fastest-growing piece of employer healthcare spending. But most employers have no idea what they are actually paying or what they can do about it."
seoTitle: "Pharmacy Benefit Costs: What Employers Can Actually Control | Benefits Collective"
metaDescription: "Learn what is driving pharmacy cost increases for employers and the specific strategies you can use to take control of your prescription drug spending."
featured: false
readingTime: "8 min read"
---

If you run a company with 50 or more employees, pharmacy costs are probably one of the fastest-growing line items in your benefits budget. And unlike most other cost increases, this one is accelerating.
...
Drug price inflation also plays a role. Many existing medications see annual price increases that far exceed general inflation. Some manufacturers raise prices multiple times per year.

And finally, the pharmacy benefit manager industry itself contributes to the problem. The way most PBMs are structured creates incentives to favor higher-cost drugs over lower-cost alternatives, because PBMs often earn more when drug costs are higher.
...
The good news is that there are concrete strategies employers can implement to take control of their pharmacy spending.
...
### Implement a Specialty Drug Management Program

Because specialty drugs represent such a large share of pharmacy spending, managing them effectively is one of the highest-impact strategies available.

A good specialty drug management program includes prior authorization for high-cost medications, step therapy requirements that ensure lower-cost alternatives are tried first, site-of-care management that steers infused medications to lower-cost outpatient settings, and biosimilar substitution policies that favor less expensive alternatives to branded biologics.

These programs can reduce specialty drug spending by 15 to 30 percent without restricting access to necessary medications.

### Audit Your PBM Contract

If you are not ready to switch PBMs, at minimum you should audit your current contract. Look at your pricing guarantees, your rebate pass-through terms, your formulary management approach, and your contract terms around termination and data ownership.

Many employers discover during an audit that their PBM contract contains terms that are unfavorable or that pricing guarantees have not been met. This gives you leverage to renegotiate.
...
Some employers are beginning to contract directly with pharmacies or drug manufacturers for certain high-cost medications. This eliminates the PBM middleman entirely for those specific drugs and can result in significant savings.

Direct contracting is still relatively new and works best for employers with larger populations, but it represents the direction the market is moving.
